...
import { RouteListSheet } from "@/components/route-list-sheet"
...
<RouteMap
  ...
  isRouteListOpen={isSheetExpanded}
...
<MapControls
      ...
      {!isSheetExpanded && <RouteSheetCollapsed onExpand={() => setIsSheetExpanded(true)} />}
      <RouteListSheet
        isOpen={isSheetExpanded}
        onClose={() => setIsSheetExpanded(false)}
        onCreateClick={handleAddRoute}
      />
