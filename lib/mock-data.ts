...
export interface ExtractionOrder {
  ...
  totalAssets?: number
  totalTopOffs?: number
  urgency?: { red: number; yellow: number; green: number; blue: number }
}
...
const route3Orders: ExtractionOrder[] = [
  ...
  { id: "r3-2", customerId: "c-r3-2", customerName: "Bee Cave Builders Supply", shipToAddress: "12600 Bee Cave Pkwy, Bee Cave, TX 78738", latitude: 30.3089, longitude: -97.9523, status: "assigned", volume: 900, scheduledDate: "2026-02-05", zoneId: "zone-austin", hubId: "hub-austin", city: "Bee Cave", state: "TX", zip: "78738", tankSize: 5000, currentLevel: 38, daysUntilEmpty: 9, priority: "Medium", lastDelivery: "2026-01-19", zone: "Bee Cave", routeId: "route-3", routeSequence: 3, orderType: "D", productBreakdown: [{ product: "200*DIESEL-ONROAD CLEAR", volume: 500 }, { product: "87 OCT W/ 10% ETH", volume: 400 }] },
  // Stop 3: Westlake Hills Auto — 700 gal (Diesel 400, Gas 300)
  { id: "r3-3", customerId: "c-r3-3", customerName: "Westlake Hills Auto", shipToAddress: "920 Westbank Dr, Westlake Hills, TX 78746", latitude: 30.2934, longitude: -97.8112, status: "assigned", volume: 700, scheduledDate: "2026-02-05", zoneId: "zone-austin", hubId: "hub-austin", city: "Westlake Hills", state: "TX", zip: "78746", tankSize: 3500, currentLevel: 55, daysUntilEmpty: 6, priority: "Medium", lastDelivery: "2026-01-17", zone: "Westlake Hills", routeId: "route-3", routeSequence: 4, orderType: "D", productBreakdown: [{ product: "200*DIESEL-ONROAD CLEAR", volume: 400 }, { product: "87 OCT W/ 10% ETH", volume: 300 }] },
  // Stop 4: Lost Creek Equipment — 1,000 gal (Diesel 600, Gas 400)
  { id: "r3-4", customerId: "c-r3-4", customerName: "Lost Creek Equipment", shipToAddress: "3800 Lost Creek Blvd, Austin, TX 78735", latitude: 30.2789, longitude: -97.8334, status: "assigned", volume: 1000, scheduledDate: "2026-02-05", zoneId: "zone-austin", hubId: "hub-austin", city: "Austin", state: "TX", zip: "78735", tankSize: 4200, currentLevel: 18, daysUntilEmpty: 2, priority: "High", lastDelivery: "2026-01-20", zone: "West Austin", routeId: "route-3", routeSequence: 5, orderType: "D", productBreakdown: [{ product: "200*DIESEL-ONROAD CLEAR", volume: 600 }, { product: "87 OCT W/ 10% ETH", volume: 400 }] },
  // Stop 5: Barton Creek Ranch — 800 gal (Diesel 500, Gas 300) — Gas 87 begins to run out here
  { id: "r3-5", customerId: "c-r3-5", customerName: "Barton Creek Ranch", shipToAddress: "4600 Barton Creek Blvd, Austin, TX 78735", latitude: 30.2456, longitude: -97.8534, status: "assigned", volume: 800, scheduledDate: "2026-02-05", zoneId: "zone-austin", hubId: "hub-austin", city: "Austin", state: "TX", zip: "78735", tankSize: 3000, currentLevel: 62, daysUntilEmpty: 11, priority: "Low", lastDelivery: "2026-01-15", zone: "Barton Creek", routeId: "route-3", routeSequence: 6, orderType: "D", productBreakdown: [{ product: "200*DIESEL-ONROAD CLEAR", volume: 500 }, { product: "87 OCT W/ 10% ETH", volume: 300 }] },
  // Stop 6: Circle C Fuel Co — 700 gal (Diesel 400, Gas 300)
  { id: "r3-6", customerId: "c-r3-6", customerName: "Circle C Fuel Co", shipToAddress: "7900 W Slaughter Ln, Austin, TX 78749", latitude: 30.2123, longitude: -97.8712, status: "assigned", volume: 700, scheduledDate: "2026-02-05", zoneId: "zone-austin", hubId: "hub-austin", city: "Austin", state: "TX", zip: "78749", tankSize: 5500, currentLevel: 45, daysUntilEmpty: 7, priority: "Medium", lastDelivery: "2026-01-18", zone: "Circle C", routeId: "route-3", routeSequence: 7, orderType: "D", productBreakdown: [{ product: "200*DIESEL-ONROAD CLEAR", volume: 400 }, { product: "87 OCT W/ 10% ETH", volume: 300 }] },
]
